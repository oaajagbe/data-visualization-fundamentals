...
# scatter plot for workingday - 'Working Day Vs. Casual'
plt.scatter(bike_sharing['workingday'], bike_sharing['casual'])
plt.title('Working Day Vs. Casual')
plt.show()

# scatter plot with the workingday - 'Working Day Vs. Registered'
...
# Based on the presented histograms, evaluate the truth value of the following sentences.
sentence_1 = True
sentence_2 = False
sentence_3 = False
sentence_4 = False